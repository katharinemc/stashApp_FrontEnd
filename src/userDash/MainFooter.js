    ...
    return (
      <span className="main ">
        <button
          name="showProducts"
          type="button"
          onClick={(e) => this.props.dispatch(changeDisplay('products'))}>Products</button>
        <button aria-label="Show Menu" value="show Menu" alt="show menu"
          name="showMenu"
          className="projectName"
          onClick={(e) => this.expandFooter()}>
          <i className="fas fa-chevron-circle-up"></i>
        </button>
        <button
          name="showLooks"
          type="button"
          onClick={(e) => this.props.dispatch(changeDisplay('looks'))}>Looks</button>
      </span>
    );
  }
